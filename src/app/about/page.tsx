...
export const metadata: Metadata = {
  title: "About Us",
  description: `Learn about ${businessInfo.name} - your trusted mobile and computer accessories store in Tirunelveli. Quality products, expert guidance, and competitive prices.`,
...
const milestones = [
  ...
  },
  {
    ...
    description: "Achieved a 4.9★ Google Rating — a testament to our commitment to quality, fair pricing, and outstanding customer service.",
    icon: "⭐",
    color: "from-amber-500 to-orange-500",
    glow: "shadow-amber-500/30",
    achievement: "4.9★ Google Rating Achieved",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-4 bg-white rounded-3xl shadow-2xl shadow-primary-900/20 border border-primary-50 p-5">
                <div className="text-4xl font-black text-primary-950 leading-none">4.9<span className="text-accent-500 text-2xl">★</span></div>
